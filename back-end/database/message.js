module.exports = {
    undetectedError: "An undetected error occurred.",
    notFoundPage: "Sorry, the requested page was not found.",
    successMessage: "Operation successful.",
    errorMessage: "An error occurred.",
    validationError: "Validation error encountered.",
    notFoundUser: "No user found (Please check email or password).",
